...
\textbf{Ultimo aggiornamento}: 14 Luglio 2026
...
\textbf{Admin revisionatori}: Bruno Tagliafierro, Raffaele Viglione, Elia Falzoni, Francesca Speriani, Benedetta Fiumi, Blerta Kacorri.
...
È possibile ritirare un libro dall'applicazione ``Polimi Library'' o dal sito della biblioteca. Dopo la prenotazione si hanno due giorni per ritirarlo, mostrando la PoliCard; in caso contrario si viene sospesi dalla biblioteca.
