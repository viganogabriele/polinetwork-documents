...
\pnSubtitle{\small Verifica su \href{https://polinet.cc/guida-matricole}{polinet.cc/guida-matricole} di stare consultando la versione pi\`u aggiornata della guida oppure scaricala direttamente da l\`i.}
...
\textbf{Ultimo aggiornamento}: 6 Settembre 2026
...
La guida può subire modifiche nel corso degli anni; assicurati di consultare sempre l'ultima versione.

Versione: $1.1$

\textbf{Contributi}: Niccolò Papini (autore principale), Gabriele Viganò.

\textbf{Admin revisionatori}: Bruno Tagliafierro, Raffaele Viglione, Elia Falzoni, Francesca Speriani, Benedetta Fiume, Blerta Kacorri.
...
\begin{enumerate}
  \item Quello ufficiale: il poli pubblica dei PDF appositi per la preparazione all'esame, di libera consultazione; oppure, passando per ogni campus del Politecnico, potete trovare il manuale in vendita in ogni PoliPrint (fotocopisteria del Politecnico di Milano). \href{https://www.polimi.it/futuri-studenti/test-e-ammissione/laurea/ingegneria/in-cosa-consiste-il-tol-e-come-prepararsi}{Link alla pagina di preparazione}
...
La graduatoria è visibile solo dopo la sua uscita: NON 2 minuti prima, NON 2 giorni prima, e NO, non esistono modi loschi per visualizzarla in anticipo, quindi non chiedetelo. Le date di uscita delle graduatorie sono segnate sulla pagina del poli al seguente link: \href{https://www.polimi.it/futuri-studenti/test-e-ammissione/laurea/ingegneria/punteggi-e-formulazione-delle-graduatorie}{Date graduatorie TOL}
...
Vuol dire che purtroppo per questa graduatoria non sei stato preso in nessun corso di studi tra quelli per cui hai espresso interesse. Devi manifestare l'interesse a partecipare alla graduatoria successiva, altrimenti verrai considerato rinunciatario e dovrai aspettare la fase successiva.
...
Se risulti "PRENOTATO" vuol dire che non sei stato preso al corso in prima posizione tra le tue preferenze, ma sei stato preso in uno degli altri. Puoi comunque iscriverti alla graduatoria successiva se non ti immatricoli: il posto verrà chiaramente perso in quella graduatoria e non è garantito che nella successiva ti venga ridato.
...
No, ma è fortemente consigliato per eventuali agevolazioni. L’ISEE ci mette circa 10 giorni lavorativi a caricarsi e, prima o poi, andrà comunque fatto: la cosa migliore è caricarlo il prima possibile.
...
BENE! Sei stato preso nei posti disponibili alla graduatoria e ti è comparso il flag "ASSEGNATO": ora hai pochissimi giorni per immatricolarti. QUINDI consigliamo fortemente di farlo subito, senza perdere tempo, per non rischiare problemi o dimenticanze dell'ultimo minuto.
...
Se ti dimentichi, ci dispiace informarti che NON potrai immatricolarti e verrai considerato rinunciatario per quest'anno, dovendo ripetere tutto (TOL e Graduatoria) l'anno dopo...
...
Sì, puoi pagarlo in tabaccheria; puoi pagarlo anche in posta.

\subsection{L'importo della prima rata viene calcolato automaticamente in base all'ISEE?}


Sì, viene calcolato in automatico.
...
Si richiede tramite CAF, oppure online dal sito dell'INPS se si è esperti; personalmente consiglio di andare al CAF.

\subsubsection{Devo richiedere un ISEE particolare?}


Sì, va richiesto l'ISEE per uso universitario. Se si richiede solo l'ISEE standard questo non sarà valido per il calcolo della fascia per il pagamento della tassa e vi verrà data la fascia massima.
...
Inizia a conoscere i tuoi nuovi colleghi e stringi amicizie prima dell'inizio dell'università, goditi l'estate e aspetta l'inizio delle lezioni.
...
Sì, l'ISEE regna sovrano. Infatti con questo si avrà la possibilità di avere la prima e la seconda rata scontata in base alla propria fascia di reddito. DUNQUE NON ASPETTATE TROPPO A RICHIEDERLO.
...
Sì, sono presenti a questa \href{https://www.polimi.it/campus-e-servizi/pari-opportunita-e-inclusione/parita-di-genere/girlspolimi}{pagina}
...
\subsection{La borsa é compatibile con il premio migliori matricole?}


Sì.

\subsection{Devo attivare la prepagata policard per usufruire dei buoni pasto?}


No, non è necessario. Potrai usare i buoni pasto direttamente dalla policard senza attivare la funzione di prepagata.
...
Ok, questo non è un problemone, ma è una cosa antipatica, ti capisco. Innanzitutto è normale non preoccuparti, succede di consegne in ritardo, prima di tutto assicurati di non averla ricevuta al tuo indirizzo di residenza (non quello di domicilio). Seconda cosa che si può fare è dare un'altra settimana dall'inizio delle lezioni, infatti la policard è affidata ad enti di consegna che possono creare ritardi. Terzo, se è passata la settimana e ancora niente scrivi alla segreteria una mail per sicurezza la procedura è: "Servizi Online" -> "Contatti e Assistenza".
...
La mail del poli per noi studenti è standard: \href{mailto:nome.cognome@mail.polimi.it}{\texttt{nome.cognome@mail.polimi.it}} il nome è seguito da dei numeri se sono presenti omonimi (nome e cognome già registrati) è anche possibile usare un secondo indirizzo, che in realtà è connesso al primo: \href{mailto:codice_persona@polimi.it}{\texttt{codice\_persona@polimi.it}}
...
Le credenziali del poli sono "\texttt{codice\_persona}" e "password", per gli studenti italiani verrà richiesta l'attivazione dell'autenticazione a due fattori obbligatoria, per gli stranieri viene richiesta solo l'accesso con credenziali.

\subsection{È davvero fondamentale ricordarsi il codice persone e addirittura la matricola?}


Sì, questi infatti vengono usati per rendere anonimi gli esiti degli esami quando vengono pubblicati e vi viene chiesto di scriverli sui fogli d'esame per lo stesso motivo, e anche come "double-check".
...
I corsi sulla sicurezza sono una garanzia che il Politecnico deve avere affinché in caso di emergenza si sappiano le procedure da svolgere, che molte volte sono banale buon senso.

\subsection{Non ho voglia di fare il corso base, mi serve?}


Sì, cioè non per sopravvivere, ma vi serve per poter sostenere gli esami. Ragazzi forza, dura 10 minuti, e sono domande tipo "Se prende fuoco un'aula, devo chiudere la porta e non dirlo a nessuno? Sì/No"
...
Salvo alcuni casi, per il quale richiediamo sempre la lettura del Regolamento del corso di studi. Sì, al Politecnico la maggior parte degli insegnamenti NON richiede propedeuticità esplicita. Si possono quindi inserire Analisi 1 e Analisi 2 nello stesso piano e superare prima la 2 della 1.
...
\begin{itemize}
  ...
  \item Selezionare la propria scuola di appartenenza (Ingegneria Industriale e dell'Informazione se un corso di ingegneria che non sia Civile o delle Costruzioni) e il proprio corso di laurea, assicurarsi di aver messo l'anno accademico corrente "\texttt{anno\_attuale/anno\_successivo}";
...
Sì, è possibile mettere l'orario su Google Calendar: basterà andare su Polimi APP, andare sulla sezione dedicata all'orario e cliccare in alto a destra il simbolo con una freccia verso l'alto, poi cliccare su "Copia link iCal"; andate quindi, tramite pagina web e modalità Desktop, sulla pagina del vostro calendario preferito e cercate "imposta tramite iCal" o "importa calendario", infine incollate il link e cliccate su importa.
...
Sì, puoi, ma attento: l'esame può differire da uno scaglione all'altro.

\section{Questionario OPIS Opinione degli studenti}


Il questionario OPIS è un questionario obbligatorio da compilare poco prima della fine del corso per potersi iscrivere all'esame.

\subsection{Il questionario è anonimo?}


Assolutamente, il questionario è 100\% anonimo. Si consiglia di compilarlo quindi in maniera onesta senza paura di ripercussioni.

\subsection{Il questionario è importante?}


Il questionario è fondamentale, i rappresentanti degli studenti usano i dati derivanti dall'OPIS per poter muovere critiche o consigli per migliorare un corso. Quindi a mettere un punteggio falso ci si perde e basta, pensateci.

\subsection{Il questionario è obbligatorio?}


Si, senza il sistema impedisce di iscriversi all'esame.
...
Sì, molto utile per ambientarsi e iniziare a conoscervi.
...
La comunicazione con i docenti avviene tramite mail, ogni docente ha una mail standard che viene presentata ad inizio lezione ed è sempre di questo standard: \href{mailto:nome.cognome@polimi.it}{nome.cognome@polimi.it}
...
L'attribuzione di questo OFA impedisce di poter conseguire e inserire insegnamenti successivi al primo anno nel piano degli studi, finché non viene assolto.
...
Sì, l'anno accademico. Se non si recupera entro la fine dell'anno accademico, infatti, non sarà possibile iscriversi al secondo anno.

\subsection{Esistono corsi per recuperare l'OFA?}


Sì, il Politecnico offre corsi che aiutano al recupero, presenti a questi link: \href{https://www.polimi.it/formazione/corsi-di-lingua}{Link corsi} e \href{https://www.polimi.it/formazione/moocs-polimi-open-knowledge}{Link MOOCS}.
...
\subsection{Cosa serve per entrare in residenza?}


Per entrare in residenza serve una fototessera di se stessi da consegnare al check-in.
...
Sì, è a questo \href{https://t.me/joinchat/jmpNOitFNFw1MzJk}{link}
...
Se si prende alloggio tramite DSU la procedura è automatica e non necessita di invio del contratto.

\href{https://www.polimi.it/studenti/tasse-borse-e-agevolazioni/diritto-allo-studio}{Guida fuorisede}

\href{https://drive.google.com/uc?export=download\&id=11WPVTGq3oo7PXgafMkvt8GONBv2LFaTL}{Modulo A: richiesta di cambio status da pendolare 90+ a fuori sede}
...
Sì, infatti il poli presenta uno sconto del 10\% per i Frecciarossa tramite registrazione con il bando presente qui: \href{https://www.polimi.it/campus-e-servizi/convenzioni-e-agevolazioni/trenitalia}{bando}
...
È possibile ritirare un libro dall'applicazione ``Polimi Library'' o dal sito della biblioteca, dopo la prenotazione si avranno 2 giorni per ritirare il libro (mostrando la policard), se non si ritira entro 2 giorni si viene sospesi dalla biblioteca.
...
\subsection{Mappa dei microonde}


A questo \href{https://www.polimi.it/campus-e-servizi/mense-e-bar}{link} potete trovare la mappa dove sono situati i microonde per ogni campus.

\subsection{Ci sono buoni pasto o agevolazioni per mangiare?}


Sì, tramite DSU: per ottenerli basta essere idonei alla borsa di studio, anche non beneficiari; anche senza borsa di studio si hanno comunque i buoni pasto.
...
Sì, tutti i requisiti sono elencati in questa \href{https://www.polimi.it/studenti/casi-particolari/passaggi-ai-corsi-di-laurea-di-ingegneria-e-auic-ingegneria-edile-e-delle-costruzioni}{pagina}
...
\section{Come contattare i rappresentanti degli studenti}
...
\section{Chi è PoliNetwork}


Probabilmente hai già usato PoliNetwork senza accorgertene. Il gruppo Telegram dove hai trovato i tuoi futuri compagni di corso lo abbiamo aperto noi, e le graduatorie del TOL che hai passato ore a controllare girano su strumenti che costruiamo e manteniamo noi.

Siamo la più grande organizzazione studentesca indipendente legata al Politecnico di Milano. Siamo nati nel 2016 da un piccolo gruppo di studenti stanchi di vedere link e gruppi sparsi ovunque, e da allora abbiamo continuato a crescere. Oggi gestiamo oltre 500 gruppi Telegram e WhatsApp su più di 30 corsi di laurea, da Leonardo a Bovisa fino a Cremona, e ogni anno accompagniamo decine di migliaia di studenti dal primo giorno di TOL fino alla laurea.

Siamo un'associazione a tutti gli effetti, con uno statuto, un direttivo eletto e centinaia di admin volontari coordinati per corso, scaglione e sede. Siamo indipendenti dal Politecnico per scelta, e questo ci lascia liberi di muoverci in fretta e di stare dalla parte degli studenti in ogni momento.

\subsection{Cosa trovi}


\begin{itemize}
  \item \textbf{Una community per il tuo corso.} Gruppi Telegram e WhatsApp dove conoscere i compagni, scambiarsi appunti e capire come funziona ogni esame.
  \item \textbf{Supporto dagli studenti che ci sono già passati.} I nostri admin rispondono ogni giorno a dubbi su ISEE, borse di studio, piano di studi, OFA e scadenze, tutta quella burocrazia che al primo anno sembra un labirinto.
  \item \textbf{Strumenti che ti semplificano la vita.} Il sito \href{https://polinetwork.org}{polinetwork.org}, le graduatorie del TOL navigabili, il bot \texttt{@PoliNetwork3bot} per trovare al volo il gruppo giusto, gli archivi di appunti e temi d'esame.
  \item \textbf{Eventi dentro e fuori dalle lezioni.} Dal Welcome Party agli aperitivi delle matricole fino ad AperiTecnico e ai workshop durante l'anno, occasioni per conoscere persone e imparare qualcosa fuori dalle aule.
  \item \textbf{Un ponte verso il lavoro.} Workshop e incontri con aziende e associazioni, per farti le prime conoscenze utili quando cercherai un tirocinio o il primo impiego.
\end{itemize}


Tutto questo è gratuito e aperto a ogni studente del Politecnico.

\subsection{Entrare in un team}


I team sono il cuore operativo di PoliNetwork. Sono cinque (IT, HR, Design and Marketing, Events and Partnerships e International) e si occupano di tutto ciò che tiene in piedi la rete, dal codice del sito alla comunicazione, dagli eventi ai rapporti con le aziende, fino all'infrastruttura tecnica.

Lavorare in un team significa costruire qualcosa che userà tutto il Politecnico. Segui progetti concreti e impari a muoverti dentro un'organizzazione strutturata, con accanto persone che nel giro di pochi mesi diventano una squadra. Per molti è il primo posto in cui mettono le mani su competenze che poi contano quando si cerca lavoro.

Ci si entra per selezione. Il comparto HR valuta le candidature e propone un colloquio, perché a chi porta avanti questi progetti chiediamo serietà e continuità. La porta però è aperta a chiunque abbia voglia di mettersi in gioco e di portare le proprie idee.

Per saperne di più scrivi a \textbf{\href{mailto:hr@polinetwork.org}{hr@polinetwork.org}}.

\subsection{Diventare admin}


Gli admin sono gli studenti che moderano i gruppi, tengono in ordine tutta la nostra struttura. Sono il cuore pulsante dell'associazione. Essere un admin è il modo più diretto per entrare nel mondo PoliNetwork ed è aperto a tutti.

Per diventarlo puoi contattare un admin di uno dei gruppi oppure scrivere a \textbf{\href{mailto:hr@polinetwork.org}{hr@polinetwork.org}}. Da lì HR ti proporrà un breve colloquio conoscitivo prima di affidarti i tuoi gruppi.

I due percorsi restano separati. Chi entra in un team può scegliere di fare anche l'admin, mentre l'admin è un ruolo a sé e non porta in automatico dentro un team.

\subsection{Dove ci trovi}


\begin{itemize}
  \item \textbf{Instagram}: \href{https://instagram.com/polinetwork\_}{\texttt{@polinetwork\_}}
  \item \textbf{Sito web}: \href{https://polinetwork.org}{polinetwork.org}
  \item \textbf{Mail generale}: \href{mailto:direttivo@polinetwork.org}{direttivo@polinetwork.org}
  \item \textbf{Candidature (HR)}: \href{mailto:hr@polinetwork.org}{hr@polinetwork.org}
\end{itemize}
